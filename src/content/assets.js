...
export const TOC = [
  { id: "logo", label: "Logo" },
  { id: "logo-variants", label: "Logo variants" },
  { id: "misuses", label: "Misuses" },
  { id: "linky", label: "Linky, the mark" },
  { id: "icon", label: "The icon" },
  { id: "product-logos", label: "Product logos" },
  { id: "co-branded", label: "Co-branded logos" },
